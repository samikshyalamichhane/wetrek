...
class CreateHelitourPackageSlidersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('helitour_package_sliders', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('helitour_package_sliders');
    }
}
