...
class CreateAdventureBookingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('adventure_bookings', function (Blueprint $table) {
            ...
            $table->unsignedInteger('adventurepackagecostanddate_id')->nullable();
            $table->foreign('adventurepackagecostanddate_id')->references('id')->on('adventure_package_costand_dates')->onDelete('cascade');
