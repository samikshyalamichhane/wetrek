...
class CreateNaturePackageSlidersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('nature_package_sliders', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('nature_package_sliders');
    }
}
