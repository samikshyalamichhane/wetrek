...
use App\Traits\TourPackageMultipleImagesTrait;

class TourPackageController extends Controller
{
    use TourPackageMultipleImagesTrait;
    protected $tourpackageslider;
    public function __construct(TourPackageSlider $tourpackageslider)
    {
      $this->tourpackageslider = $tourpackageslider;
    }
    ...
    {
        $details = TourPackage::orderBy('updated_at', 'desc')->get();
        return view('admin.tour_package.list', compact('details'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.tour_package.create', compact('destinations','tours','activities'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $thatDesti = TourPackage::create($formData);
        return redirect()->route('tourpackage.edit', $thatDesti->id)->with('message', 'Tours Package Added Successfully.');
    }
    ...
    {
        $detail = TourPackage::findorfail($id);
        $d_id = $id;
        $destinations = Destination::orderBy('updated_at', 'desc')->get();
        $tours = Tour::orderBy('updated_at', 'desc')->get();
        $activities = Activity::orderBy('updated_at', 'desc')->get();

        return view('admin.tour_package.edit', compact('detail', 'destinations', 'd_id', 'tours','activities'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        //   $formData['trip_of_the_month'] = is_null($request->trip_of_the_month) ? 0 : 1;
          ...
          return redirect()->route('tourpackage.index')->with('message', 'Tour Package Edited Successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        $package->delete();
        return redirect()->back()->with('message', 'Tours Package Deleted Successfully.');
    ...
    public function generateSlug($title, $slug, $oldRecord)
    {
      ...
      $count = TourPackage::where('slug', $slugReturn)->count();
