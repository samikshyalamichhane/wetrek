...
class TravelersreviewController extends Controller
{
    /**
    ...
    {
        $details = Travelersreview::orderBy('updated_at', 'desc')->get();
        return view('admin.travelersreview.list', compact('details'));
    }
    ...
    {
        return view('admin.travelersreview.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        Travelersreview::create($formInput);
        return redirect()->route('travelersreview.index')->with('message', 'Travelersreview Create Successfuly.');
    }
    ...
    {
        $detail = Travelersreview::findorfail($id);
        return view('admin.travelersreview.edit', compact('detail'));
    }
    ...
    public function update(Request $request, $id)
    {
      ...
      $oldRecord = Travelersreview::findorfail($id);
      ...
      return redirect()->route('travelersreview.index')->with('message', 'Travelersreview Edited Successfuly.');
    }
    ...
    {
        $record = Travelersreview::findorfail($id);
        if($record->image){
          $this->unlinkImage($record->image);
        }
        $record->delete();
        return redirect()->route('travelersreview.index')->with('message', 'Travelersreview Deleted Successfuly.');
    }
    ...
    public function generateSlug($title, $slug, $oldRecord)
    {
      ...
      $count = Travelersreview::where('slug', $slugReturn)->count();
