...
class HistoryController extends Controller
{
    ...
    {
        $details = History::orderBy('updated_at', 'desc')->get();
        return view('admin.history.list', compact('details'));
    }
    ...
    public function store(Request $request)
    {
        ...
        History::create($formInput);
        return redirect()->route('history.index')->with('message', 'History Create Successfuly.');
    }
    ...
    {
        $detail = History::findorfail($id);
        return view('admin.history.edit', compact('detail'));
    }
    ...
    public function update(Request $request, $id)
    {
      ...
      $oldRecord = History::findorfail($id);
      ...
      return redirect()->route('history.index')->with('message', 'History Edited Successfuly.');
    }
    ...
    public function destroy($id)
    {
        ...
        $record->delete();
        return redirect()->route('history.index')->with('message', 'History Deleted Successfuly.');
    }
    ...
    public function generateSlug($title, $slug, $oldRecord)
    {
      ...
      $count = History::where('slug', $slugReturn)->count();
