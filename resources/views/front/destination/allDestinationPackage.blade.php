...
{{-- {{asset('assets/front/    ')}} --}}
     ...
     <!-- ========== Package Banner ========== -->
     <div class="tourmaster-single-header inner-image" style="background-image: url('{{asset('images/main/'. $destination->banner_image)}}');">
            ...
            <div class="destination-feature-single">
                <div class="container">
                    ...
                    <div class="destination-feature-list">
                        <div class="row mt-5">
                            @if (isset($destinationPackages[0]))
                            @foreach ($destinationPackages as $type)
