...
<title>{{$tourPackage->package_name}}-{{ $dashboard_settings->page_title }}</title>
...
{{-- {{asset('assets/front/   ')}} --}}
    ...
    <main>
        <section class="hero-image">
            <div class="hero-image__frame gradient-overlay" style="background-image: url('{{asset('images/main/'.$tourPackage->image)}}');">
                <div class="container">
                    <h1 class="inner-hero-title"> {{$tourPackage->package_name}} - {{$tourPackage->days_and_nights}} </h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row main" id="main-content">
                    <div id="content" class="trip-detail trip-detail--alt col-lg-8 col-12">
                        ...
                        <!-- TRIP DETAIL TABLE -->
                        @if (isset($tourPackage->destination->country_name))
                            ...
                            <div class="mx-auto mb-4 col-lg-3 col-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$tourPackage->destination->country_name}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($tourPackage->activity->name))
                            <div class="mx-auto mb-4 col-lg-4 col-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$tourPackage->activity->name}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($tourPackage->accommodation))
                            <div class="mx-auto mb-4 col-lg-5 col-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$tourPackage->accommodation}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($tourPackage->tour->name))
                            <div class="mx-auto mb-4 col-lg-3 col-6">
                                <div class="media">
                                    <svg class="trip-detail__icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$tourPackage->tour->name}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($tourPackage->distance))
                            <div class="mx-auto mb-4 col-lg-4 col-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$tourPackage->distance}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($tourPackage->start_point) || isset($tourPackage->end_point))
                            <div class="mx-auto mb-4 col-lg-5 col-6">
                                <div class="media">
                                    <svg class="trip-detail__icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$tourPackage->start_point}}/{{$tourPackage->end_point}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($tourPackage->days_and_nights))
                            <div class="mx-auto mb-4 col-lg-3 col-6">
                                <div class="media">
                                    <svg class="trip-detail__icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$tourPackage->days_and_nights}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($tourPackage->max_altitude))
                            <div class="mx-auto mb-4 col-lg-4 col-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$tourPackage->max_altitude}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($tourPackage->meals_include))
                            <div class="mx-auto mb-4 col-lg-5 col-6">
                                <div class="media">
                                    <svg class="trip-detail__icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$tourPackage->meals_include}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($tourPackage->group_size))
                            <div class="mx-auto mb-4 col-lg-3 col-6">
                                <div class="media">
                                <img src="{{asset('assets/front/images/icon-group.svg')}}" alt="" class="img-fluid icon-table">
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$tourPackage->group_size}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($tourPackage->nature_of_trek))
                            <div class="mx-auto mb-4 col-lg-4 col-6">
                                <div class="media">
                                <img src="{{asset('assets/front/images/icon-nature.svg')}}" alt="" class="img-fluid icon-table">
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$tourPackage->nature_of_trek}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($tourPackage->best_season))
                            <div class="mx-auto mb-4 col-lg-5 col-6">
                                <div class="media">
                                    <svg class="trip-detail__icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$tourPackage->best_season}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($tourPackage->trip_code))
                            <div class="mx-auto mb-4 col-lg-3 col-6">
                                <div class="media">
                                    <svg class="trip-detail__icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$tourPackage->trip_code}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($tourPackage->activity_per_day))
                            <div class="mx-auto mb-4 col-lg-4 col-6">
                                <div class="media">
                                    <svg class="trip-detail__icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$tourPackage->activity_per_day}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($tourPackage->transportation))
                            <div class="mx-auto mb-4 col-lg-5 col-6">
                                <div class="media">
                                    <svg class="trip-detail__icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$tourPackage->transportation}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($tourPackage->grade))
                            <div class="b-2 col-lg-3 col-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$tourPackage->grade}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                        ...
                        <div class="trip-detail__card">
                            @if (isset($tourPackage->description))
                            <h2 class="trip-detail__card--title">{{$tourPackage->package_name}} Overview</h2>
                            <p>{{$tourPackage->description}}</p>

                            @endif

                            @if (isset($tourPackage->trip_highlights_title) || isset($tourPackage->trip_highlights_description))
                            <div class="highlight-list">
                                <div class="sub-title">
                                    <svg class="search-icon">
                                        <use xlink:href="{{asset('assets/front/images/sprite.svg')}}#icon-badge"></use>
                                    </svg>
                                    <span>{{$tourPackage->trip_highlights_title}}</span>
                                </div>
                                <ul class="list list--hand-bullet">
                                {!! $tourPackage->trip_highlights_description !!}
                                </ul>
                            </div>
                            @endif

                            @if (isset($tourPackage->perks_title) || isset($tourPackage->perks_description))
                            <h3 class="highlight-list__title">{{$tourPackage->perks_title}}</h3>
                            <ul class="list list--hand-bullet">
                                {{-- <li> --}}
                                    {!! $tourPackage->perks_description !!}
                                {{-- </li> --}}
                            </ul>
                            @endif
                        ...
                        @if (isset($tourPackage->overview_title) || isset($tourPackage->overview_description) || isset($tourPackage->overview_highlights))
                        <div class="trip-detail__card" id="overview">
                            <div class="highlight-list">
                                <div class="sub-title">
                                    ...
                                    <span>{{ $tourPackage->overview_title }}</span>
                                </div>
                                @if (isset($tourPackage->overview_description))
                                <p>
                                    <span style="font-weight: 400;">
                                    {!! $tourPackage->overview_description !!}
                                    </span>
                                </p>
                                @endif

                                @if (isset($tourPackage->overview_highlights))
                                <div class="highlight-card">
                                    <p>
                                    {!! $tourPackage->overview_highlights !!}
                                    </p>
                                </div>
                                @endif
                        ...
                        <!-- 3rd -->
                        @if (isset($tourPackage->slider__images[0]) || isset($tourPackage->photo_video_title) || isset($tourPackage->youtube_video_link))
                        <div class="trip-detail__card" id="photos-videos">
                            <div class="sub-title">
                                <svg class="search-icon">
                                    <use xlink:href="{{asset('assets/front/images/sprite.svg')}}#icon-file-picture"></use>
                                </svg>
                                @if (isset($tourPackage->photo_video_title))
                                <h2>{{ $tourPackage->photo_video_title }}</h2>
                                @else
                                <h2>{{ $tourPackage->package_name }} Photo</h2>

                                @endif
                            </div>
                            @if (isset($tourPackage->youtube_video_link))
                            <div class="mt-5 mb-1 video-list">
                                <iframe width="100%" height="500" src="{{ $tourPackage->youtube_video_link }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>
                            @endif

                            @if (isset($tourPackage->slider__images))
                            <div class="image-list">
                                <div class="row">
                                    @foreach(@$tourPackage->slider__images as $key => $data)
                                    <div class="mb-3 col-4">
                                        <a href="{{ asset('images/tour/package/multiple/'. $data->sliderimages) }}" data-lightbox="image-gallery">
                                            <img src="{{ asset('images/tour/package/multiple/'. $data->sliderimages) }}" alt="" class="img-fluid w-100">
                                        </a>
                                    </div>
                                    @endforeach
                                </div>
                        ...
                        @if (isset($tourPackage->includes_title) || isset($tourPackage->includes_description))
                        <div class="trip-detail__card" id="includes-excludes">
                            <div class="sub-title">
                                <i class="fa fa-check-circle"></i>
                                <h2>{{ $tourPackage->includes_title }}</h2>
                            </div>
                            <ul class="list list--check-bullet marb-30">
                                {!! $tourPackage->includes_description !!}
                        ...
                        @if (isset($tourPackage->excludes_title) || isset($tourPackage->excludes_description))
                        <div class="trip-detail__card">
                            <div class="sub-title">
                                <i class="fa fa-times-circle"></i>
                                <h2>{{ $tourPackage->excludes_title }}</h2>
                            </div>
                            <ul class="list list--cross-bullet marb-30">
                                {!! $tourPackage->excludes_description !!}
                        ...
                        <!-- TRIP DETAIL #MAP -->
                        @if (isset($tourPackage->map_title) || isset($tourPackage->map_image))
                        <div class="trip-detail__card" id="map">
                            <div class="sub-title">
                                <i class="fa fa-map-o"></i>
                                <h2>{{ $tourPackage->map_title }} </h2>
                            </div>

                            <div class="route-map">
                                <img class="lozad" alt="everest base camp trek map" src="{{asset('/images/listing/'. $tourPackage->map_image)}}" data-loaded="true" class="img-fluid w-100">
                            </div>
                        </div>
                        @endif
                        ...
                        @if (isset($tourPackage->trip_info_title) || isset($tourPackage->trip_info_description) || isset($tourPackage->trip_info_special_notes))
                        <div class="trip-detail__card" id="tripinfo">
                            @if (isset($tourPackage->trip_info_title))
                            <div class="sub-title">
                                <i class="fa fa-info-circle"></i>
                                <h2>{{$tourPackage->trip_info_title}}</h2>
                            </div>
                            @endif
                            <div>
                                <div class="note-list">
                                    @if (isset($tourPackage->trip_info_description))
                                    <div class="note-item">
                                        <p>{!! $tourPackage->trip_info_description !!}</p>
                                    </div>
                                    @endif
                                    @if (isset($tourPackage->trip_info_special_notes))
                                    <div class="highlight-card">
                                        <p>{!! $tourPackage->trip_info_special_notes !!}</p>
                                    </div>
                                    @endif
                        ...
                        @if (isset($tourPackage->tourpackageequipment[0]))
                        <div class="trip-detail__card trip-detail__card--equipment" id="equipments">
                            @foreach(@$tourPackage->tourpackageequipment as $key => $data)
                            <div class="sub-title">
                        ...
                        @if (isset($tourPackage->tourcostanddate[0]))
                        <div class="border-0 trip-detail__card trip-detail__departure-card" id="cost-dates">
                            ...
                            <table id="booking-dates" class="table table-hover" style="display: table; position: relative; ">
                                ...
                                <tbody class="departure-list">
                                    @foreach(@$tourPackage->tourcostanddate()->where('published',1)->get() as $key => $data)
                                    @php
                        ...
                        <div class="border-0 trip-detail__card">
                            <div class="sub-title">
                                ...
                                <h2>Guided {{$tourPackage->package_name}}</h2>
                            </div>
                            <div class="tag-items">
                        ...
                        <!-- DISCOUNTED PRICE -->
                        @if (isset($tourPackage->tourpackagegdp[0]))
                        <div class="border-none trip-detail__card">
                            ...
                            <table class="discount-card discount-card--transparent">
                                ...
                                <tbody class="discount-card__list">
                                    @foreach(@$tourPackage->tourpackagegdp as $key => $data)
                                        <tr>
                        ...
                        @if (isset($tourPackage->package_pdf) || isset($tourPackage->map_image))
                        <div class="border-0 trip-detail__card">
                            <div class="sub-title">
                            ...
                            <div class="trip-detail__info-btn">
                                @if (isset($tourPackage->package_pdf))
                                <a href="{{asset('/files/'. $tourPackage->package_pdf)}}" target="_blank">
                                    <i class="fa fa-file"></i>
                                    Download the Trip PDF
                                </a>
                                @endif
                                @if (isset($tourPackage->map_image))
                                <a href="{{asset('/images/listing/'. $tourPackage->map_image)}}" target="_blank" download>
                                    <i class="fa fa-map"></i>
                                    Download Map
                                </a>
                                @endif
                    ...
                    <!-- SIDER BAR STICKY -->
                    @if (isset($tourPackage->days_and_nights) || isset($tourPackage->price) || isset($tourPackage->discount_price))
                            ...
                            <div class="mx-auto sidebar sidebar-block">
                                    <div class="sidebar-block__card sidebar-block__card--pattern">
                                        ...
                                        <div class="sidebar-block__card-item package-price package-price--large">
                                            <span class="package-price__trip-days">{{$tourPackage->days_and_nights}} </span>
                                            <span class="package-price__regular-price">from
                                                <span class="large-del">US$ {{$tourPackage->price}}</span></span>
                                            <br>
                                            <span class="package-price__sale-price">
                                                US$
                                                <strong>{{$tourPackage->discount_price}}</strong><sup>pp</sup>
                                            </span>
                                        </div>
                                        {{-- @php
                                        $save = $tourPackage->price - $tourPackage->discount_price;
                                        @endphp
                                        ...
                                        <div class="sidebar-block__card-item sidebar-block__card-item--border">
                                            ...
                                            <a href="{{route('tourPackageInquire', $tourPackage->slug)}}" target="_blank" data-bypass-react="true" class="btn btn--border btn--fullwidth btn--small">
                                                Ask Questions
                                            </a>
                                        </div>
                                ...
                                <div class="mx-auto sidebar sidebar-block">
                                    <div class="sidebar-block__card sidebar-block__card--pattern">
                                        ...
                                        <div class="sidebar-block__card-item package-price package-price--large">
                                            ...
                                            <a href="{{route('tourPackageDetails', $package->slug)}}" target="_blank">
        ...
        <!-- FAQ BLOCK -->
        @if (isset($tourPackage->tourpackagefaq[0]))
        <div class="faq-block">
            <div class="container">
                ...
                <div class="accordion-list">
                    @foreach(@$tourPackage->tourpackagefaq as $key => $data)
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item cta-item">
                        <a class="btn btn-cta" href="{{route('tourPackageInquire', $tourPackage->slug)}}">
                            Book The Trip
                        </a>
                    </li>
                </ul>
