...
<title>{{$adventurePackage->package_name}}-{{ $dashboard_settings->page_title }}</title>
...
{{-- {{asset('assets/front/   ')}} --}}
    ...
    <main>
        <section class="hero-image">
            <div class="hero-image__frame gradient-overlay" style="background-image: url('{{asset('images/main/'.$adventurePackage->image)}}');">
                <div class="container">
                    <h1 class="inner-hero-title"> {{$adventurePackage->package_name}} - {{$adventurePackage->days_and_nights}} </h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row main" id="main-content">
                    <div id="content" class="trip-detail trip-detail--alt col-lg-8 col-12">
                        ...
                        <!-- TRIP DETAIL TABLE -->
                        @if (isset($adventurePackage->destination->country_name))
                            ...
                            <div class="mx-auto mb-4 col-lg-3 col-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$adventurePackage->destination->country_name}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($adventurePackage->activity->name))
                            <div class="mx-auto mb-4 col-lg-4 col-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$adventurePackage->activity->name}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($adventurePackage->accommodation))
                            <div class="mx-auto mb-4 col-lg-5 col-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$adventurePackage->accommodation}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($adventurePackage->adventure->name))
                            <div class="mx-auto mb-4 col-lg-3 col-6">
                                <div class="media">
                                    <svg class="trip-detail__icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$adventurePackage->adventure->name}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($adventurePackage->distance))
                            <div class="mx-auto mb-4 col-lg-4 col-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$adventurePackage->distance}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($adventurePackage->start_point) || isset($adventurePackage->end_point))
                            <div class="mx-auto mb-4 col-lg-5 col-6">
                                <div class="media">
                                    <svg class="trip-detail__icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$adventurePackage->start_point}}/{{$adventurePackage->end_point}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($adventurePackage->days_and_nights))
                            <div class="mx-auto mb-4 col-lg-3 col-6">
                                <div class="media">
                                    <svg class="trip-detail__icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$adventurePackage->days_and_nights}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($adventurePackage->max_altitude))
                            <div class="mx-auto mb-4 col-lg-4 col-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$adventurePackage->max_altitude}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($adventurePackage->meals_include))
                            <div class="mx-auto mb-4 col-lg-5 col-6">
                                <div class="media">
                                    <svg class="trip-detail__icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$adventurePackage->meals_include}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($adventurePackage->group_size))
                            <div class="mx-auto mb-4 col-lg-3 col-6">
                                <div class="media">
                                <img src="{{asset('assets/front/images/icon-group.svg')}}" alt="" class="img-fluid icon-table">
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$adventurePackage->group_size}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($adventurePackage->nature_of_trek))
                            <div class="mx-auto mb-4 col-lg-4 col-6">
                                <div class="media">
                                <img src="{{asset('assets/front/images/icon-nature.svg')}}" alt="" class="img-fluid icon-table">
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$adventurePackage->nature_of_trek}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($adventurePackage->best_season))
                            <div class="mx-auto mb-4 col-lg-5 col-6">
                                <div class="media">
                                    <svg class="trip-detail__icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$adventurePackage->best_season}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($adventurePackage->trip_code))
                            <div class="mx-auto mb-4 col-lg-3 col-6">
                                <div class="media">
                                    <svg class="trip-detail__icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$adventurePackage->trip_code}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($adventurePackage->activity_per_day))
                            <div class="mx-auto mb-4 col-lg-4 col-6">
                                <div class="media">
                                    <svg class="trip-detail__icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$adventurePackage->activity_per_day}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($adventurePackage->transportation))
                            <div class="mx-auto mb-4 col-lg-5 col-6">
                                <div class="media">
                                    <svg class="trip-detail__icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$adventurePackage->transportation}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($adventurePackage->grade))
                            <div class="b-2 col-lg-3 col-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$adventurePackage->grade}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                        ...
                        <div class="trip-detail__card">
                            @if (isset($adventurePackage->description))
                            <h2 class="trip-detail__card--title">{{$adventurePackage->package_name}} Overview</h2>
                            <p>{{$adventurePackage->description}}</p>

                            @endif

                            @if (isset($adventurePackage->trip_highlights_title) || isset($adventurePackage->trip_highlights_description))
                            <div class="highlight-list">
                                <div class="sub-title">
                                    <svg class="search-icon">
                                        <use xlink:href="{{asset('assets/front/images/sprite.svg')}}#icon-badge"></use>
                                    </svg>
                                    <span>{{$adventurePackage->trip_highlights_title}}</span>
                                </div>
                                <ul class="list list--hand-bullet">
                                {!! $adventurePackage->trip_highlights_description !!}
                                </ul>
                            </div>
                            @endif

                            @if (isset($adventurePackage->perks_title) || isset($adventurePackage->perks_description))
                            <h3 class="highlight-list__title">{{$adventurePackage->perks_title}}</h3>
                            <ul class="list list--hand-bullet">
                                {{-- <li> --}}
                                    {!! $adventurePackage->perks_description !!}
                                {{-- </li> --}}
                            </ul>
                            @endif
                        ...
                        @if (isset($adventurePackage->overview_title) || isset($adventurePackage->overview_description) || isset($adventurePackage->overview_highlights))
                        <div class="trip-detail__card" id="overview">
                            <div class="highlight-list">
                                <div class="sub-title">
                                    ...
                                    <span>{{ $adventurePackage->overview_title }}</span>
                                </div>
                                @if (isset($adventurePackage->overview_description))
                                <p>
                                    <span style="font-weight: 400;">
                                    {!! $adventurePackage->overview_description !!}
                                    </span>
                                </p>
                                @endif

                                @if (isset($adventurePackage->overview_highlights))
                                <div class="highlight-card">
                                    <p>
                                    {!! $adventurePackage->overview_highlights !!}
                                    </p>
                                </div>
                                @endif
                        ...
                        <!-- 3rd -->
                        @if (isset($adventurePackage->slider__images[0]) || isset($adventurePackage->photo_video_title) || isset($adventurePackage->youtube_video_link))
                        <div class="trip-detail__card" id="photos-videos">
                            <div class="sub-title">
                                <svg class="search-icon">
                                    <use xlink:href="{{asset('assets/front/images/sprite.svg')}}#icon-file-picture"></use>
                                </svg>
                                @if (isset($adventurePackage->photo_video_title))
                                <h2>{{ $adventurePackage->photo_video_title }}</h2>
                                @else
                                <h2>{{ $adventurePackage->package_name }} Photo</h2>

                                @endif
                            </div>
                            @if (isset($adventurePackage->youtube_video_link))
                            <div class="mt-5 mb-1 video-list">
                                <iframe width="100%" height="500" src="{{ $adventurePackage->youtube_video_link }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>
                            @endif

                            @if (isset($adventurePackage->slider__images))
                            <div class="image-list">
                                <div class="row">
                                    @foreach(@$adventurePackage->slider__images as $key => $data)
                                    <div class="mb-3 col-4">
                                        <a href="{{ asset('images/adventure/package/multiple/'. $data->sliderimages) }}" data-lightbox="image-gallery">
                                            <img src="{{ asset('images/adventure/package/multiple/'. $data->sliderimages) }}" alt="" class="img-fluid w-100">
                                        </a>
                                    </div>
                                    @endforeach
                                </div>
                        ...
                        @if (isset($adventurePackage->adventurepackageitinerary[0]))
                        <div class="trip-detail__card" id="itinerary">
                            <div class="sub-title">
                                <svg class="search-icon">
                                    <use xlink:href="{{asset('assets/front/images/sprite.svg')}}#icon-list2"></use>
                                </svg>
                                <h2>{{$adventurePackage->package_name}}</h2>
                            </div>
                            <ol class="itinerary-list">
                            @foreach(@$adventurePackage->adventurepackageitinerary as $key => $value)
                        ...
                        @if (isset($adventurePackage->includes_title) || isset($adventurePackage->includes_description))
                        <div class="trip-detail__card" id="includes-excludes">
                            <div class="sub-title">
                                <i class="fa fa-check-circle"></i>
                                <h2>{{ $adventurePackage->includes_title }}</h2>
                            </div>
                            <ul class="list list--check-bullet marb-30">
                                {!! $adventurePackage->includes_description !!}
                        ...
                        @if (isset($adventurePackage->excludes_title) || isset($adventurePackage->excludes_description))
                        <div class="trip-detail__card">
                            <div class="sub-title">
                                <i class="fa fa-times-circle"></i>
                                <h2>{{ $adventurePackage->excludes_title }}</h2>
                            </div>
                            <ul class="list list--cross-bullet marb-30">
                                {!! $adventurePackage->excludes_description !!}
                        ...
                        <!-- TRIP DETAIL #MAP -->
                        @if (isset($adventurePackage->map_title) || isset($adventurePackage->map_image))
                        <div class="trip-detail__card" id="map">
                            <div class="sub-title">
                                <i class="fa fa-map-o"></i>
                                <h2>{{ $adventurePackage->map_title }} </h2>
                            </div>

                            <div class="route-map">
                                <img class="lozad" alt="everest base camp trek map" src="{{asset('/images/listing/'. $adventurePackage->map_image)}}" data-loaded="true" class="img-fluid w-100">
                            </div>
                        </div>
                        @endif
                        ...
                        @if (isset($adventurePackage->trip_info_title) || isset($adventurePackage->trip_info_description) || isset($adventurePackage->trip_info_special_notes))
                        <div class="trip-detail__card" id="tripinfo">
                            @if (isset($adventurePackage->trip_info_title))
                            <div class="sub-title">
                                <i class="fa fa-info-circle"></i>
                                <h2>{{$adventurePackage->trip_info_title}}</h2>
                            </div>
                            @endif
                            <div>
                                <div class="note-list">
                                    @if (isset($adventurePackage->trip_info_description))
                                    <div class="note-item">
                                        <p>{!! $adventurePackage->trip_info_description !!}</p>
                                    </div>
                                    @endif
                                    @if (isset($adventurePackage->trip_info_special_notes))
                                    <div class="highlight-card">
                                        <p>{!! $adventurePackage->trip_info_special_notes !!}</p>
                                    </div>
                                    @endif
                        ...
                        @if (isset($adventurePackage->adventurepackageequipment[0]))
                        <div class="trip-detail__card trip-detail__card--equipment" id="equipments">
                            @foreach(@$adventurePackage->adventurepackageequipment as $key => $data)
                            <div class="sub-title">
                        ...
                        @if (isset($adventurePackage->adventurepackagecostanddate[0]))
                        <div class="border-0 trip-detail__card trip-detail__departure-card" id="cost-dates">
                            ...
                            <table id="booking-dates" class="table table-hover" style="display: table; position: relative; ">
                                ...
                                <tbody class="departure-list">
                                    @foreach(@$adventurePackage->adventurepackagecostanddate()->where('published',1)->get() as $key => $data)
                                    @php
                        ...
                        <div class="border-0 trip-detail__card">
                            <div class="sub-title">
                                ...
                                <h2>Guided {{$adventurePackage->package_name}}</h2>
                            </div>
                            <div class="tag-items">
                        ...
                        <!-- DISCOUNTED PRICE -->
                        @if (isset($adventurePackage->adventurepackagegdp[0]))
                        <div class="border-none trip-detail__card">
                            ...
                            <table class="discount-card discount-card--transparent">
                                ...
                                <tbody class="discount-card__list">
                                    @foreach(@$adventurePackage->adventurepackagegdp as $key => $data)
                                        <tr>
                        ...
                        @if (isset($adventurePackage->package_pdf) || isset($adventurePackage->map_image))
                        <div class="border-0 trip-detail__card">
                            <div class="sub-title">
                            ...
                            <div class="trip-detail__info-btn">
                                @if (isset($adventurePackage->package_pdf))
                                <a href="{{asset('/files/'. $adventurePackage->package_pdf)}}" target="_blank">
                                    <i class="fa fa-file"></i>
                                    Download the Trip PDF
                                </a>
                                @endif
                                @if (isset($adventurePackage->map_image))
                                <a href="{{asset('/images/listing/'. $adventurePackage->map_image)}}" target="_blank" download>
                                    <i class="fa fa-map"></i>
                                    Download Map
                                </a>
                                @endif
                    ...
                    <!-- SIDER BAR STICKY -->
                    @if (isset($adventurePackage->days_and_nights) || isset($adventurePackage->price) || isset($adventurePackage->discount_price))
                            ...
                            <div class="mx-auto sidebar sidebar-block">
                                    <div class="sidebar-block__card sidebar-block__card--pattern">
                                        ...
                                        <div class="sidebar-block__card-item package-price package-price--large">
                                            <span class="package-price__trip-days">{{$adventurePackage->days_and_nights}} </span>
                                            <span class="package-price__regular-price">from
                                                <span class="large-del">US$ {{$adventurePackage->price}}</span></span>
                                            <br>
                                            <span class="package-price__sale-price">
                                                US$
                                                <strong>{{$adventurePackage->discount_price}}</strong><sup>pp</sup>
                                            </span>
                                        </div>
                                        {{-- @php
                                        $save = $adventurePackage->price - $adventurePackage->discount_price;
                                        @endphp
                                        ...
                                        <div class="sidebar-block__card-item sidebar-block__card-item--border">
                                            ...
                                            <a href="{{route('adventurePackageInquire', $adventurePackage->slug)}}" target="_blank" data-bypass-react="true" class="btn btn--border btn--fullwidth btn--small">
                                                Ask Questions
                                            </a>
                                        </div>
                                    ...
                                    <div class="mx-auto sidebar sidebar-block">
                                        <div class="sidebar-block__card sidebar-block__card--pattern">
                                            ...
                                            <div class="sidebar-block__card-item package-price package-price--large">
                                                ...
                                                <a href="{{route('adventurePackageDetails', $package->slug)}}" target="_blank">
        ...
        <!-- FAQ BLOCK -->
        @if (isset($adventurePackage->adventurepackagefaq[0]))
        <div class="faq-block">
            <div class="container">
                ...
                <div class="accordion-list">
                    @foreach(@$adventurePackage->adventurepackagefaq as $key => $data)
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item cta-item">
                        <a class="btn btn-cta" href="{{route('adventurePackageInquire', $adventurePackage->slug)}}">
                            Book The Trip
                        </a>
                    </li>
                </ul>
