...
<title>{{$naturePackage->package_name}}-{{ $dashboard_settings->page_title }}</title>
...
{{-- {{asset('assets/front/   ')}} --}}
    ...
    <main>
        <section class="hero-image">
            <div class="hero-image__frame gradient-overlay" style="background-image: url('{{asset('images/main/'.$naturePackage->image)}}');">
                <div class="container">
                    <h1 class="inner-hero-title"> {{$naturePackage->package_name}} - {{$naturePackage->days_and_nights}} </h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row main" id="main-content">
                    <div id="content" class="trip-detail trip-detail--alt col-lg-8 col-12">
                        ...
                        <!-- TRIP DETAIL TABLE -->
                        @if (isset($naturePackage->destination->country_name))
                        <div class="row trip-detail__table">
                            <div class="mx-auto mb-4 col-lg-3 col-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$naturePackage->destination->country_name}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($naturePackage->activity->name))
                            <div class="mx-auto mb-4 col-lg-4 col-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$naturePackage->activity->name}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($naturePackage->accommodation))
                            <div class="mx-auto mb-4 col-lg-5 col-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$naturePackage->accommodation}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            ...
                            @endif
                            @if (isset($naturePackage->distance))
                            <div class="mx-auto mb-4 col-lg-4 col-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$naturePackage->distance}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($naturePackage->start_point) || isset($naturePackage->end_point))
                            <div class="mx-auto mb-4 col-lg-5 col-6">
                                <div class="media">
                                    <svg class="trip-detail__icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$naturePackage->start_point}}/{{$naturePackage->end_point}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($naturePackage->days_and_nights))
                            <div class="mx-auto mb-4 col-lg-3 col-6">
                                <div class="media">
                                    <svg class="trip-detail__icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$naturePackage->days_and_nights}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($naturePackage->max_altitude))
                            <div class="mx-auto mb-4 col-lg-4 col-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$naturePackage->max_altitude}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($naturePackage->meals_include))
                            <div class="mx-auto mb-4 col-lg-5 col-6">
                                <div class="media">
                                    <svg class="trip-detail__icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$naturePackage->meals_include}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($naturePackage->group_size))
                            <div class="mx-auto mb-4 col-lg-3 col-6">
                                <div class="media">
                                <img src="{{asset('assets/front/images/icon-group.svg')}}" alt="" class="img-fluid icon-table">
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$naturePackage->group_size}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($naturePackage->nature_of_trek))
                            <div class="mx-auto mb-4 col-lg-4 col-6">
                                <div class="media">
                                <img src="{{asset('assets/front/images/icon-nature.svg')}}" alt="" class="img-fluid icon-table">
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$naturePackage->nature_of_trek}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($naturePackage->best_season))
                            <div class="mx-auto mb-4 col-lg-5 col-6">
                                <div class="media">
                                    <svg class="trip-detail__icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$naturePackage->best_season}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($naturePackage->trip_code))
                            <div class="mx-auto mb-4 col-lg-3 col-6">
                                <div class="media">
                                    <svg class="trip-detail__icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$naturePackage->trip_code}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($naturePackage->activity_per_day))
                            <div class="mx-auto mb-4 col-lg-4 col-6">
                                <div class="media">
                                    <svg class="trip-detail__icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$naturePackage->activity_per_day}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($naturePackage->transportation))
                            <div class="mx-auto mb-4 col-lg-5 col-6">
                                <div class="media">
                                    <svg class="trip-detail__icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$naturePackage->transportation}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if (isset($naturePackage->grade))
                            <div class="b-2 col-lg-3 col-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="trip-detail__table--subtitle">{{$naturePackage->grade}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endif
                        ...
                        <div class="trip-detail__card">
                            @if (isset($naturePackage->description))
                            <h2 class="trip-detail__card--title">{{$naturePackage->package_name}} Overview</h2>
                            <p>{{$naturePackage->description}}</p>

                            @endif

                            @if (isset($naturePackage->trip_highlights_title) || isset($naturePackage->trip_highlights_description))
                            <div class="highlight-list">
                                <div class="sub-title">
                                    <svg class="search-icon">
                                        <use xlink:href="{{asset('assets/front/images/sprite.svg')}}#icon-badge"></use>
                                    </svg>
                                    <span>{{$naturePackage->trip_highlights_title}}</span>
                                </div>
                                <ul class="list list--hand-bullet">
                                {!! $naturePackage->trip_highlights_description !!}
                                </ul>
                            </div>
                            @endif

                            @if (isset($naturePackage->perks_title) || isset($naturePackage->perks_description))
                            <h3 class="highlight-list__title">{{$naturePackage->perks_title}}</h3>
                            <ul class="list list--hand-bullet">
                                {{-- <li> --}}
                                    {!! $naturePackage->perks_description !!}
                                {{-- </li> --}}
                            </ul>
                            @endif
                        ...
                        @if (isset($naturePackage->overview_title) || isset($naturePackage->overview_description) || isset($naturePackage->overview_highlights))
                        <div class="trip-detail__card" id="overview">
                            <div class="highlight-list">
                                <div class="sub-title">
                                    ...
                                    <span>{{ $naturePackage->overview_title }}</span>
                                </div>
                                @if (isset($naturePackage->overview_description))
                                <p>
                                    <span style="font-weight: 400;">
                                    {!! $naturePackage->overview_description !!}
                                    </span>
                                </p>
                                @endif

                                @if (isset($naturePackage->overview_highlights))
                                <div class="highlight-card">
                                    <p>
                                    {!! $naturePackage->overview_highlights !!}
                                    </p>
                                </div>
                                @endif
                        ...
                        <!-- 3rd -->
                        @if (isset($naturePackage->slider__images[0]) || isset($naturePackage->photo_video_title) || isset($naturePackage->youtube_video_link))
                        <div class="trip-detail__card" id="photos-videos">
                            <div class="sub-title">
                                <svg class="search-icon">
                                    <use xlink:href="{{asset('assets/front/images/sprite.svg')}}#icon-file-picture"></use>
                                </svg>
                                @if (isset($naturePackage->photo_video_title))
                                <h2>{{ $naturePackage->photo_video_title }}</h2>
                                @else
                                <h2>{{ $naturePackage->package_name }} Photo</h2>

                                @endif
                            </div>
                            @if (isset($naturePackage->youtube_video_link))
                            <div class="mt-5 mb-1 video-list">
                                <iframe width="100%" height="500" src="{{ $naturePackage->youtube_video_link }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>
                            @endif

                            @if (isset($naturePackage->slider__images))
                            <div class="image-list">
                                <div class="row">
                                    @foreach(@$naturePackage->slider__images as $key => $data)
                                    <div class="mb-3 col-4">
                                        <a href="{{ asset('images/nature/package/multiple/'. $data->sliderimages) }}" data-lightbox="image-gallery">
                                            <img src="{{ asset('images/nature/package/multiple/'. $data->sliderimages) }}" alt="" class="img-fluid w-100">
                                        </a>
                                    </div>
                                    @endforeach
                                </div>
                        ...
                        @if (isset($naturePackage->naturepackageitinerary[0]))
                        <div class="trip-detail__card" id="itinerary">
                            <div class="sub-title">
                                <svg class="search-icon">
                                    <use xlink:href="{{asset('assets/front/images/sprite.svg')}}#icon-list2"></use>
                                </svg>
                                <h2>{{$naturePackage->package_name}}</h2>
                            </div>
                            <ol class="itinerary-list">
                            @foreach(@$naturePackage->naturepackageitinerary as $key => $value)
                        ...
                        @if (isset($naturePackage->includes_title) || isset($naturePackage->includes_description))
                        <div class="trip-detail__card" id="includes-excludes">
                            <div class="sub-title">
                                <i class="fa fa-check-circle"></i>
                                <h2>{{ $naturePackage->includes_title }}</h2>
                            </div>
                            <ul class="list list--check-bullet marb-30">
                                {!! $naturePackage->includes_description !!}
                        ...
                        @if (isset($naturePackage->excludes_title) || isset($naturePackage->excludes_description))
                        <div class="trip-detail__card">
                            <div class="sub-title">
                                <i class="fa fa-times-circle"></i>
                                <h2>{{ $naturePackage->excludes_title }}</h2>
                            </div>
                            <ul class="list list--cross-bullet marb-30">
                                {!! $naturePackage->excludes_description !!}
                        ...
                        <!-- TRIP DETAIL #MAP -->
                        @if (isset($naturePackage->map_title) || isset($naturePackage->map_image))
                        <div class="trip-detail__card" id="map">
                            <div class="sub-title">
                                <i class="fa fa-map-o"></i>
                                <h2>{{ $naturePackage->map_title }} </h2>
                            </div>

                            <div class="route-map">
                                <img class="lozad" alt="everest base camp trek map" src="{{asset('/images/listing/'. $naturePackage->map_image)}}" data-loaded="true" class="img-fluid w-100">
                            </div>
                        </div>
                        @endif
                        ...
                        @if (isset($naturePackage->trip_info_title) || isset($naturePackage->trip_info_description) || isset($naturePackage->trip_info_special_notes))
                        <div class="trip-detail__card" id="tripinfo">
                            @if (isset($naturePackage->trip_info_title))
                            <div class="sub-title">
                                <i class="fa fa-info-circle"></i>
                                <h2>{{$naturePackage->trip_info_title}}</h2>
                            </div>
                            @endif
                            <div>
                                <div class="note-list">
                                    @if (isset($naturePackage->trip_info_description))
                                    <div class="note-item">
                                        <p>{!! $naturePackage->trip_info_description !!}</p>
                                    </div>
                                    @endif
                                    @if (isset($naturePackage->trip_info_special_notes))
                                    <div class="highlight-card">
                                        <p>{!! $naturePackage->trip_info_special_notes !!}</p>
                                    </div>
                                    @endif
                        ...
                        @if (isset($naturePackage->naturepackageequipment[0]))
                        <div class="trip-detail__card trip-detail__card--equipment" id="equipments">
                            @foreach(@$naturePackage->naturepackageequipment as $key => $data)
                            <div class="sub-title">
                        ...
                        @if (isset($naturePackage->naturepackagecostanddate[0]))
                        <div class="border-0 trip-detail__card trip-detail__departure-card" id="cost-dates">
                            ...
                            <table id="booking-dates" class="table table-hover" style="display: table; position: relative; ">
                                ...
                                <tbody class="departure-list">
                                    @foreach(@$naturePackage->naturepackagecostanddate()->where('published',1)->get() as $key => $data)
                                    @php
                        ...
                        <div class="border-0 trip-detail__card">
                            <div class="sub-title">
                                ...
                                <h2>Guided {{$naturePackage->package_name}}</h2>
                            </div>
                            <div class="tag-items">
                        ...
                        <!-- DISCOUNTED PRICE -->
                        @if (isset($naturePackage->naturepackagegdp[0]))
                        <div class="border-none trip-detail__card">
                            ...
                            <table class="discount-card discount-card--transparent">
                                ...
                                <tbody class="discount-card__list">
                                    @foreach(@$naturePackage->naturepackagegdp as $key => $data)
                                        <tr>
                        ...
                        @if (isset($naturePackage->package_pdf) || isset($naturePackage->map_image))
                        <div class="border-0 trip-detail__card">
                            <div class="sub-title">
                            ...
                            <div class="trip-detail__info-btn">
                                @if (isset($naturePackage->package_pdf))
                                <a href="{{asset('/files/'. $naturePackage->package_pdf)}}" target="_blank">
                                    <i class="fa fa-file"></i>
                                    Download the Trip PDF
                                </a>
                                @endif
                                @if (isset($naturePackage->map_image))
                                <a href="{{asset('/images/listing/'. $naturePackage->map_image)}}" target="_blank" download>
                                    <i class="fa fa-map"></i>
                                    Download Map
                                </a>
                                @endif
                    ...
                    <!-- SIDER BAR STICKY -->
                    @if (isset($naturePackage->days_and_nights) || isset($naturePackage->price) || isset($naturePackage->discount_price))
                            ...
                            <div class="mx-auto sidebar sidebar-block">
                                    <div class="sidebar-block__card sidebar-block__card--pattern">
                                        ...
                                        <div class="sidebar-block__card-item package-price package-price--large">
                                            <span class="package-price__trip-days">{{$naturePackage->days_and_nights}} </span>
                                            <span class="package-price__regular-price">from
                                                <span class="large-del">US$ {{$naturePackage->price}}</span></span>
                                            <br>
                                            <span class="package-price__sale-price">
                                                US$
                                                <strong>{{$naturePackage->discount_price}}</strong><sup>pp</sup>
                                            </span>
                                        </div>
                                        {{-- @php
                                        $save = $naturePackage->price - $naturePackage->discount_price;
                                        @endphp
                                        ...
                                        <div class="sidebar-block__card-item sidebar-block__card-item--border">
                                            ...
                                            <a href="{{route('naturePackageInquire', $naturePackage->slug)}}" target="_blank" data-bypass-react="true" class="btn btn--border btn--fullwidth btn--small">
                                                Ask Questions
                                            </a>
                                        </div>
                                    ...
                                    <div class="mx-auto sidebar sidebar-block">
                                        <div class="sidebar-block__card sidebar-block__card--pattern">
                                            ...
                                            <div class="sidebar-block__card-item package-price package-price--large">
                                                ...
                                                <a href="{{route('naturePackageDetails', $package->slug)}}" target="_blank">
        ...
        <!-- FAQ BLOCK -->
        @if (isset($naturePackage->naturepackagefaq[0]))
        <div class="faq-block">
            <div class="container">
                ...
                <div class="accordion-list">
                    @foreach(@$naturePackage->naturepackagefaq as $key => $data)
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item cta-item">
                        <a class="btn btn-cta" href="{{route('naturePackageInquire', $naturePackage->slug)}}">
                            Book The Trip
                        </a>
                    </li>
                </ul>
