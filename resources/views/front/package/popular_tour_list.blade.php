    ...
    <main>
        <div class="container">
            <h2 class="section-title">
                View All Our Popular Tours
            </h2>

            <div class="row">
                @foreach($popularPackage as $package)
                <div class="mx-auto mb-4 col-lg-4 col-sm-12">
                    <div class="border-0 card package__card">
                        <a href="{{route('popularPackageDetails', $package->slug)}}">
                            ...
                            <div class="card-body">
                                ...
                                {{-- <div class="package__card--rating">
                                ...
                                <div class="package__card--price">
                                    <span class="discount">Rs. {{$package->price}}</span>
                                    <span class="cost">Rs. {{$package->discount_price}}</span>
                                </div>
