...
<title>{{$trekkingandhikingPackage->package_name}}-{{ $dashboard_settings->page_title }}</title>
...
<main>
    <section class="hero-image">
        <div class="hero-image__frame gradient-overlay" style="background-image: url('{{asset('images/main/'.$trekkingandhikingPackage->image)}}');">
            <div class="container">
                <h1 class="inner-hero-title"> {{$trekkingandhikingPackage->package_name}} - {{$trekkingandhikingPackage->days_and_nights}} </h1>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row main" id="main-content">
                <div id="content" class="trip-detail trip-detail--alt col-lg-8 col-12">
                    ...
                    <!-- TRIP DETAIL TABLE -->
                    @if (isset($trekkingandhikingPackage->destination->country_name))
                        ...
                        <div class="mx-auto mb-4 col-lg-3 col-6">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <h6 class="trip-detail__table--subtitle">{{$trekkingandhikingPackage->destination->country_name}}</h6>
                                </div>
                            </div>
                        </div>
                        @endif
                        @if (isset($trekkingandhikingPackage->activity->name))
                        <div class="mx-auto mb-4 col-lg-4 col-6">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <h6 class="trip-detail__table--subtitle">{{$trekkingandhikingPackage->activity->name}}</h6>
                                </div>
                            </div>
                        </div>
                        @endif
                        @if (isset($trekkingandhikingPackage->accommodation))
                        <div class="mx-auto mb-4 col-lg-5 col-6">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <h6 class="trip-detail__table--subtitle">{{$trekkingandhikingPackage->accommodation}}</h6>
                                </div>
                            </div>
                        </div>
                        @endif
                        @if (isset($trekkingandhikingPackage->region->name))
                        <div class="mx-auto mb-4 col-lg-3 col-6">
                            <div class="media">
                                <svg class="trip-detail__icon">
                                ...
                                <div class="media-body">
                                    ...
                                    <h6 class="trip-detail__table--subtitle">{{$trekkingandhikingPackage->region->name}}</h6>
                                </div>
                            </div>
                        </div>
                        @endif
                        @if (isset($trekkingandhikingPackage->distance))
                        <div class="mx-auto mb-4 col-lg-4 col-6">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <h6 class="trip-detail__table--subtitle">{{$trekkingandhikingPackage->distance}}</h6>
                                </div>
                            </div>
                        </div>
                        @endif
                        @if (isset($trekkingandhikingPackage->start_point) || isset($trekkingandhikingPackage->end_point))
                        <div class="mx-auto mb-4 col-lg-5 col-6">
                            <div class="media">
                                <svg class="trip-detail__icon">
                                ...
                                <div class="media-body">
                                    ...
                                    <h6 class="trip-detail__table--subtitle">{{$trekkingandhikingPackage->start_point}}/{{$trekkingandhikingPackage->end_point}}</h6>
                                </div>
                            </div>
                        </div>
                        @endif
                        @if (isset($trekkingandhikingPackage->days_and_nights))
                        <div class="mx-auto mb-4 col-lg-3 col-6">
                            <div class="media">
                                <svg class="trip-detail__icon">
                                ...
                                <div class="media-body">
                                    ...
                                    <h6 class="trip-detail__table--subtitle">{{$trekkingandhikingPackage->days_and_nights}}</h6>
                                </div>
                            </div>
                        </div>
                        @endif
                        @if (isset($trekkingandhikingPackage->max_altitude))
                        <div class="mx-auto mb-4 col-lg-4 col-6">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <h6 class="trip-detail__table--subtitle">{{$trekkingandhikingPackage->max_altitude}}</h6>
                                </div>
                            </div>
                        </div>
                        @endif
                        @if (isset($trekkingandhikingPackage->meals_include))
                        <div class="mx-auto mb-4 col-lg-5 col-6">
                            <div class="media">
                                <svg class="trip-detail__icon">
                                ...
                                <div class="media-body">
                                    ...
                                    <h6 class="trip-detail__table--subtitle">{{$trekkingandhikingPackage->meals_include}}</h6>
                                </div>
                            </div>
                        </div>
                        @endif
                        @if (isset($trekkingandhikingPackage->group_size))
                        <div class="mx-auto mb-4 col-lg-3 col-6">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <h6 class="trip-detail__table--subtitle">{{$trekkingandhikingPackage->group_size}}</h6>
                                </div>
                            </div>
                        </div>
                        @endif
                        @if (isset($trekkingandhikingPackage->nature_of_trek))
                        <div class="mx-auto mb-4 col-lg-4 col-6">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <h6 class="trip-detail__table--subtitle">{{$trekkingandhikingPackage->nature_of_trek}}</h6>
                                </div>
                            </div>
                        </div>
                        @endif
                        @if (isset($trekkingandhikingPackage->best_season))
                        <div class="mx-auto mb-4 col-lg-5 col-6">
                            <div class="media">
                                <svg class="trip-detail__icon">
                                ...
                                <div class="media-body">
                                    ...
                                    <h6 class="trip-detail__table--subtitle">{{$trekkingandhikingPackage->best_season}}</h6>
                                </div>
                            </div>
                        </div>
                        @endif
                        @if (isset($trekkingandhikingPackage->trip_code))
                        <div class="mx-auto mb-4 col-lg-3 col-6">
                            <div class="media">
                                <svg class="trip-detail__icon">
                                ...
                                <div class="media-body">
                                    ...
                                    <h6 class="trip-detail__table--subtitle">{{$trekkingandhikingPackage->trip_code}}</h6>
                                </div>
                            </div>
                        </div>
                        @endif
                        @if (isset($trekkingandhikingPackage->activity_per_day))
                        <div class="mx-auto mb-4 col-lg-4 col-6">
                            <div class="media">
                                <svg class="trip-detail__icon">
                                ...
                                <div class="media-body">
                                    ...
                                    <h6 class="trip-detail__table--subtitle">{{$trekkingandhikingPackage->activity_per_day}}</h6>
                                </div>
                            </div>
                        </div>
                        @endif
                        @if (isset($trekkingandhikingPackage->transportation))
                        <div class="mx-auto mb-4 col-lg-5 col-6">
                            <div class="media">
                                <svg class="trip-detail__icon">
                                ...
                                <div class="media-body">
                                    ...
                                    <h6 class="trip-detail__table--subtitle">{{$trekkingandhikingPackage->transportation}}</h6>
                                </div>
                            </div>
                        </div>
                        @endif
                        @if (isset($trekkingandhikingPackage->grade))
                        <div class="b-2 col-lg-3 col-6">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <h6 class="trip-detail__table--subtitle">{{$trekkingandhikingPackage->grade}}</h6>
                                </div>
                            </div>
                        </div>
                        @endif
                    ...
                    <div class="trip-detail__card">
                        @if (isset($trekkingandhikingPackage->description))
                        <h2 class="trip-detail__card--title">{{$trekkingandhikingPackage->package_name}} Overview</h2>
                        <p>{{$trekkingandhikingPackage->description}}</p>
                        @endif
                        @if (isset($trekkingandhikingPackage->trip_highlights_title) || isset($trekkingandhikingPackage->trip_highlights_description))
                        <div class="highlight-list">
                            <div class="sub-title">
                                <svg class="search-icon">
                                    <use xlink:href="{{asset('assets/front/images/sprite.svg')}}#icon-badge"></use>
                                </svg>
                                <span>{{$trekkingandhikingPackage->trip_highlights_title}}</span>
                            </div>
                            <ul class="list list--hand-bullet">
                                {!! $trekkingandhikingPackage->trip_highlights_description !!}
                            </ul>
                        </div>
                        @endif
                        @if (isset($trekkingandhikingPackage->perks_title) || isset($trekkingandhikingPackage->perks_description))
                        <h3 class="highlight-list__title">{{$trekkingandhikingPackage->perks_title}}</h3>
                        <ul class="list list--hand-bullet">
                            {{-- <li> --}}
                            {!! $trekkingandhikingPackage->perks_description !!}
                            {{-- </li> --}}
                        </ul>
                        @endif
                    </div>
                    @if (isset($trekkingandhikingPackage->overview_title) || isset($trekkingandhikingPackage->overview_description) || isset($trekkingandhikingPackage->overview_highlights))
                    <div class="trip-detail__card" id="overview">
                        <div class="highlight-list">
                            <div class="sub-title">
                                ...
                                <span>{{ $trekkingandhikingPackage->overview_title }}</span>
                            </div>
                            @if (isset($trekkingandhikingPackage->overview_description))
                            <p>
                                <span style="font-weight: 400;">
                                    {!! $trekkingandhikingPackage->overview_description !!}
                                </span>
                            </p>
                            @endif
                            @if (isset($trekkingandhikingPackage->overview_highlights))
                            <div class="highlight-card">
                                <p>
                                    {!! $trekkingandhikingPackage->overview_highlights !!}
                                </p>
                            </div>
                            @endif
                        </div>
                    ...
                    @endif
                    <!-- 3rd -->
                    @if (isset($trekkingandhikingPackage->slider__images[0]) || isset($trekkingandhikingPackage->photo_video_title) || isset($trekkingandhikingPackage->youtube_video_link))
                    <div class="trip-detail__card" id="photos-videos">
                        <div class="sub-title">
                            <svg class="search-icon">
                                <use xlink:href="{{asset('assets/front/images/sprite.svg')}}#icon-file-picture"></use>
                            </svg>
                            @if (isset($trekkingandhikingPackage->photo_video_title))
                            <h2>{{ $trekkingandhikingPackage->photo_video_title }}</h2>
                            @else
                            <h2>{{ $trekkingandhikingPackage->package_name }} Photo</h2>

                            @endif
                        </div>
                        @if (isset($trekkingandhikingPackage->youtube_video_link))
                        <div class="mt-5 mb-1 video-list">
                            <iframe width="100%" height="500" src="{{ $trekkingandhikingPackage->youtube_video_link }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        @endif
                        @if (isset($trekkingandhikingPackage->slider__images))
                        <div class="image-list">
                            <div class="row">
                                @foreach(@$trekkingandhikingPackage->slider__images as $key => $data)
                                <div class="mb-3 col-4">
                                    <a href="{{ asset('images/package/multiple/'. $data->sliderimages) }}" data-lightbox="image-gallery">
                                        <img src="{{ asset('images/package/multiple/'. $data->sliderimages) }}" alt="" class="img-fluid w-100">
                                    </a>
                                </div>
                                @endforeach
                            </div>
                    ...
                    @if (isset($trekkingandhikingPackage->packageitinerary[0]))
                    <div class="trip-detail__card" id="itinerary">
                        <div class="sub-title">
                            <svg class="search-icon">
                                <use xlink:href="{{asset('assets/front/images/sprite.svg')}}#icon-list2"></use>
                            </svg>
                            <h2>{{$trekkingandhikingPackage->package_name}}</h2>
                        </div>
                        <ol class="itinerary-list">
                            @foreach(@$trekkingandhikingPackage->packageitinerary as $key => $value)
                    ...
                    @if (isset($trekkingandhikingPackage->includes_title) || isset($trekkingandhikingPackage->includes_description))
                    <div class="trip-detail__card" id="includes-excludes">
                        <div class="sub-title">
                            <i class="fa fa-check-circle"></i>
                            <h2>{{ $trekkingandhikingPackage->includes_title }}</h2>
                        </div>
                        <ul class="list list--check-bullet marb-30">
                            {!! $trekkingandhikingPackage->includes_description !!}
                    ...
                    <div class="trip-detail__card">
                        <div class="sub-title">
                            ...
                            <h2>{{ $trekkingandhikingPackage->excludes_title }}</h2>
                        </div>
                        <div class="list list--cross-bullet marb-30">
                            {!! $trekkingandhikingPackage->excludes_description !!}
                    ...
                    <!-- TRIP DETAIL #MAP -->
                    @if (isset($trekkingandhikingPackage->excludes_title) || isset($trekkingandhikingPackage->excludes_description))
                    <div class="trip-detail__card" id="map">
                        <div class="sub-title">
                            <i class="fa fa-map-o"></i>
                            <h2>{{ $trekkingandhikingPackage->map_title }} </h2>
                        </div>

                        <div class="route-map">
                            <img class="lozad" alt="everest base camp trek map" src="{{asset('/images/listing/'. $trekkingandhikingPackage->map_image)}}" data-loaded="true" class="img-fluid w-100">
                        </div>
                    </div>
                    @endif
                    <!-- END TRIP DETAIL #MAP -->
                    ...
                    @if (isset($trekkingandhikingPackage->trip_info_title) || isset($trekkingandhikingPackage->trip_info_description) || isset($trekkingandhikingPackage->trip_info_special_notes))
                    <div class="trip-detail__card" id="tripinfo">
                        @if (isset($trekkingandhikingPackage->trip_info_title))
                        <div class="sub-title">
                            <i class="fa fa-info-circle"></i>
                            <h2>{{$trekkingandhikingPackage->trip_info_title}}</h2>
                        </div>
                        @endif
                        <div>
                            <div class="note-list">
                                @if (isset($trekkingandhikingPackage->trip_info_description))
                                <div class="note-item">
                                    <p>{!! $trekkingandhikingPackage->trip_info_description !!}</p>
                                </div>
                                @endif
                                @if (isset($trekkingandhikingPackage->trip_info_special_notes))
                                <div class="highlight-card">
                                    <p>{!! $trekkingandhikingPackage->trip_info_special_notes !!}</p>
                                </div>
                                @endif
                    ...
                    @if (isset($trekkingandhikingPackage->packageequipment[0]))
                    <div class="trip-detail__card trip-detail__card--equipment" id="equipments">
                        @foreach(@$trekkingandhikingPackage->packageequipment as $key => $data)
                        <div class="sub-title">
                    ...
                    @if (isset($trekkingandhikingPackage->costanddate[0]))
                    <div class="border-0 trip-detail__card trip-detail__departure-card" id="cost-dates">
                        ...
                        <table id="booking-dates" class="table table-hover" style="display: table; position: relative; ">
                            ...
                            <tbody class="departure-list">
                                @foreach(@$trekkingandhikingPackage->costanddate()->where('published',1)->get() as $key => $data)
                                @php
                    ...
                    <div class="border-0 trip-detail__card">
                        <div class="sub-title">
                            ...
                            <h2>Guided {{$trekkingandhikingPackage->package_name}}</h2>
                        </div>
                        <div class="tag-items">
                    ...
                    <!-- DISCOUNTED PRICE -->
                    @if (isset($trekkingandhikingPackage->packagegdp[0]))
                    <div class="border-none trip-detail__card">
                        ...
                        <table class="discount-card discount-card--transparent">
                            ...
                            <tbody class="discount-card__list">
                                @foreach(@$trekkingandhikingPackage->packagegdp as $key => $data)
                                <tr>
                    ...
                    @if (isset($trekkingandhikingPackage->package_pdf) || isset($trekkingandhikingPackage->map_image))
                    <div class="border-0 trip-detail__card">
                        <div class="sub-title">
                        ...
                        <div class="trip-detail__info-btn">
                            @if (isset($trekkingandhikingPackage->package_pdf))
                            <a href="{{asset('/files/'. $trekkingandhikingPackage->package_pdf)}}" target="_blank">
                                <i class="fa fa-file"></i>
                                Download the Trip PDF
                            </a>
                            @endif
                            @if (isset($trekkingandhikingPackage->map_image))
                            <a href="{{asset('/images/listing/'. $trekkingandhikingPackage->map_image)}}" target="_blank" download>
                                <i class="fa fa-map"></i>
                                Download Map
                            </a>
                            @endif
                ...
                <!-- SIDER BAR STICKY -->
                @if (isset($trekkingandhikingPackage->days_and_nights) || isset($trekkingandhikingPackage->price) || isset($trekkingandhikingPackage->discount_price))
                    ...
                    <div class="mx-auto sidebar sidebar-block">
                        <div class="sidebar-block__card sidebar-block__card--pattern">
                            ...
                            <div class="sidebar-block__card-item package-price package-price--large">
                                <span class="package-price__trip-days">{{$trekkingandhikingPackage->days_and_nights}} </span>
                                <span class="package-price__regular-price">from
                                    <span class="large-del">US$ {{$trekkingandhikingPackage->price}}</span></span>
                                <br>
                                <span class="package-price__sale-price">
                                    US$
                                    <strong>{{$trekkingandhikingPackage->discount_price}}</strong><sup>pp</sup>
                                </span>
                            </div>
                            {{-- @php
                                    $save = $trekkingandhikingPackage->price - $trekkingandhikingPackage->discount_price;
                                    @endphp
                        ...
                        <div class="sidebar-block__card-item discount-card discount-card--toggle discount-card--small">
                            <h2 class="accordion__action-btn">We Offer Group Discount</h2>
                            <div class="discount-card__accordion" style="display: none;">
                                <table class="discount-card__table">
                                    ...
                                    <tbody class="sidebar-block__card-item discount-card__list">
                                        <tr>
                                            <td class="person">1 Pax</td>
                                            <td class="discount-price">US$ 1470</td>
                                        </tr>
                                        <tr>
                                            <td class="person">2 Paxes</td>
                                            <td class="discount-price">US$ 1190</td>
                                        </tr>
                                        <tr>
                                            <td class="person">3 Paxes</td>
                                            <td class="discount-price">US$ 1175</td>
                                        </tr>
                                        <tr>
                                            <td class="person">4 - 6Paxes </td>
                                            <td class="discount-price">US$ 1140</td>
                                        </tr>
                                        <tr>
                                            <td class="person">7 - 12Paxes </td>
                                            <td class="discount-price">US$ 1100</td>
                                        </tr>
                                        <tr>
                                            <td class="person">13 - 18Paxes </td>
                                            <td class="discount-price">US$ 1075</td>
                                        </tr>
                                        <tr>
                                            <td class="person">19 - 24Paxes </td>
                                            <td class="discount-price">US$ 1050</td>
                                        </tr>
                                        <tr>
                                            <td class="person">25 - 30Paxes </td>
                                            <td class="discount-price">US$ 1030</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="sidebar-block__card-item sidebar-block__card-item--border">
                            ...
                            <a href="{{route('packageInquire', $trekkingandhikingPackage->slug)}}" target="_blank" data-bypass-react="true" class="btn btn--border btn--fullwidth btn--small">
                                Ask Questions
                            </a>
                        </div>
                    ...
                    <div class="mx-auto sidebar sidebar-block">
                        <div class="sidebar-block__card sidebar-block__card--pattern">
                            ...
                            <div class="sidebar-block__card-item package-price package-price--large">
                                ...
                                <a href="{{route('packageDetails', $package->slug)}}" target="_blank">
    ...
    <!-- FAQ BLOCK -->
    @if (isset($trekkingandhikingPackage->packagefaq[0]))
    <div class="faq-block">
        <div class="container">
            ...
            <div class="accordion-list">
                @foreach(@$trekkingandhikingPackage->packagefaq as $key => $data)
    ...
    <section class="trip-section">
        ...
        <div class="container">
            <div class="row">
                @foreach($similarTrekkingPackage as $package)
    ...
    <section class="associated-block">
        <div class="container">
            <h2 class="feature-block__slider-title">We Are Associated With</h2>
            <div class="row">
                @foreach ($dashboard_associates as $associate)
                <div class="col-lg-2 col-md-3 col-4 mx-auto mb-3">
                    <img class="lozad img-fluid" data-src="{{asset('images/main/'. $associate->image)}}" alt="Nepal digital pictography" src="{{asset('images/main/'. $associate->image)}}" data-loaded="true">
                </div>
                @endforeach
            </div>
        </div>
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item cta-item">
                    <a class="btn btn-cta" href="{{route('packageInquire', $trekkingandhikingPackage->slug)}}">
                        Book The Trip
                    </a>
                </li>
            </ul>
