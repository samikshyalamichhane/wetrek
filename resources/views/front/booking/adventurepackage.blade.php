  ...
  <main class="mt-5">
    <div class="container">
        <div class="form-section__heading">
            ...
            <h1 class="form-section__heading--secondary">{{$adventurecostanddate->adventurepackage->package_name}} - {{ $adventurecostanddate->cad_day }}</h1>
        </div>
        ...
        <div class="form-section__content">
            <div class="row">
                <div class="col-lg-6 col-sm-12 mx-auto">
                    ...
                    <form action="{{route('saveAdventurePackageBooking', $adventurecostanddate->id)}}" method="post"  class="form form-horizontal ">
                        @csrf
                        ...
                        <div class="form-group form-group-mrb-60">
                            ...
                            <input type="text" class="form-control custom-control date" value="{{ $adventurecostanddate->cad_date_from }}" readonly="" name="departure_date" id="departure_date" autocomplete="off">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <button type="button" data-vendor_id="{{$adventurecostanddate->id}}" id="subAdventureBookingPrice" class="sub subAdventureBookingPrice">-</button>
                                <input type="number" name="number_of_person" id="1" value="1" min="1" max="20" class="participant-input"/>
                                <button type="button" data-vendor_id="{{$adventurecostanddate->id}}" id="addAdventureBookingPrice" class="add addAdventureBookingPrice">+</button>
                            </div>
                        </div>
                        ...
                        <div class="form-group border-bottom pb-4">
                            <div class="row">
                                ...
                                <div class="col-4 text-right">
                                    <input type="hidden" name="package_price_per_person" id="package_price_per_person" value="{{ $adventurecostanddate->cad_discount_price }}">
                                    <span class="package-price-amount">Rs. {{ $adventurecostanddate->cad_discount_price }}</span>
                                </div>
                            </div>
                        </div>
                        {{-- <div class="form-group border-bottom pb-4">
