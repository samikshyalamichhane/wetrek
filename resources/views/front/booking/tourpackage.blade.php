  ...
  <main class="mt-5">
    <div class="container">
        <div class="form-section__heading">
            ...
            <h1 class="form-section__heading--secondary">{{$tourcostanddate->tourpackage->package_name}} - {{ $tourcostanddate->cad_day }}</h1>
        </div>
        ...
        <div class="form-section__content">
            <div class="row">
                <div class="col-lg-6 col-sm-12 mx-auto">
                    ...
                    <form action="{{route('saveTourPackageBooking', $tourcostanddate->id)}}" method="post"  class="form form-horizontal ">
                        @csrf
                        ...
                        <div class="form-group form-group-mrb-60">
                            ...
                            <input type="text" class="form-control custom-control date" value="{{ $tourcostanddate->cad_date_from }}" readonly="" name="departure_date" id="departure_date" autocomplete="off">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <button type="button" data-vendor_id="{{$tourcostanddate->id}}" id="subTourBookingPrice" class="sub subTourBookingPrice">-</button>
                                {{-- <input type="button" value="+" id="plus" /> --}}
                                <input type="number" name="number_of_person" id="1" value="1" min="1" max="20" class="participant-input"/>
                                <button type="button" data-vendor_id="{{$tourcostanddate->id}}" id="addTourBookingPrice" class="add addTourBookingPrice">+</button>
                            </div>
                        </div>
                        ...
                        <div class="form-group border-bottom pb-4">
                            <div class="row">
                                ...
                                <div class="col-4 text-right">
                                    <input type="hidden" name="package_price_per_person" id="package_price_per_person" value="{{ $tourcostanddate->cad_discount_price }}">
                                    <span class="package-price-amount">Rs. {{ $tourcostanddate->cad_discount_price }}</span>
                                </div>
                            </div>
                        </div>
