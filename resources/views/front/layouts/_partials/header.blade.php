        ...
        <div class="collapse navbar-collapse" id="tp_main_menu">
            ...
            <ul class="navbar-nav">
                ...
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        <li><a href="single-dtlpage.html">Everest Helicopter Tour in Nepal</a></li>
                        <li><a href="single-dtlpage.html">Lumbini Day Tour</a></li>
                        <li><a href="single-dtlpage.html">Kathmandu-Pokhara-Chitwan Tour</a></li>
                    </ul>
                </li> -->
