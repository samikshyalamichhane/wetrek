...
<div class="page-heading">
    <h1 class="page-title">Adventure Bookings</h1>
    <!-- <ol class="breadcrumb">
...
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">All Adventure Bookings</div>
            <div>
                <a class="btn btn-info btn-md" href="{{route('adventurebookings.create')}}">Adventure Package Inquery</a>
            </div>
        </div>
                ...
                <tbody>
                  ...
                  @if($details->count())
                    ...
                    <tr>
                      ...
                      <td>{{$data->email}}</td>
                      <td>{{$data->country}}</td>
                      <td>{{@$data->adventurepackagecostanddate->adventurepackage->package_name}}</td>
                      <td>{{$data->type}}</td>
