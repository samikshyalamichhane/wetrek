...
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">All Adventure</div>
            <div>
                <a class="btn btn-info btn-md" href="{{route('adventure.create')}}">Add Adventure</a>
            </div>
        </div>
                  ...
                  @if($details->count())
                    ...
                    <tr>
                      ...
                      <td>{{$data->published == 1 ? 'Published' : 'Not Published'}}</td>
                        ...
                        <td>
                            <a href="{{route('adventure.edit', $data->id)}}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>

                              <form class="adjust-delete-button" action="{{route('adventure.destroy', $data->id)}}" method="post">
                                  @csrf
                                  @method('delete')
