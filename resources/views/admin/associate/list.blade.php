...
<div class="page-heading">
    <h1 class="page-title">WE ARE ACCREDITATION WITH</h1>
    <!-- <ol class="breadcrumb">
...
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">All Accreditations</div>
            <div>
                <a class="btn btn-info btn-md" href="{{route('associate.create')}}">Add Accreditations</a>
            </div>
        </div>
                  ...
                  @if($details->count())
                    ...
                    <tr>
                      ...
                      <td>{{$data->published == 1 ? 'Published' : 'Not Published'}}</td>
                        ...
                        <td>
                            <a href="{{route('associate.edit', $data->id)}}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>

                              <form class="adjust-delete-button" action="{{route('associate.destroy', $data->id)}}" method="post">
                                  @csrf
                                  @method('delete')
