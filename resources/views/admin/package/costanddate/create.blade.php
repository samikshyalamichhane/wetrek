    ...
    @include('admin.package.include.topnavbar')
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="ibox">
                  <div class="ibox-head">
                      <div class="ibox-title">Add Cost and Date</div>
                  ...
                  <form method="post" action="{{route('costanddate.store', [$d_id])}}" enctype="multipart/form-data">
                    @csrf
                  <div class="ibox-body" style="">
                    ...
                    @endif
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="date" name="start_date" value="{{old('start_date')}}" placeholder="Enter Start Date">
                            </div>
                            <div class="form-group">
                                <label>End Date</label>
                                <input class="form-control" type="date" name="end_date" value="{{old('end_date')}}" placeholder="Enter End Date">
                            </div>
                            <div class="form-group">
                                <label>Status</label>
                                <input class="form-control" type="text" name="status" value="{{old('status')}}" placeholder="Eg: Confirmed">
                            </div>
                            <div class="form-group">
                                <label>Price</label>
                                <input class="form-control" type="text" name="price" value="{{old('price')}}" placeholder="E.g $200">
                            </div>
                            {{-- <div class="form-group">
                                <label>6+ People Price</label>
                                <input class="form-control" type="text" name="price3" value="{{old('price3')}}" placeholder="E.g 400">
                            </div> --}}
                            {{-- <div class="form-group">
                                <label>End Date</label>
