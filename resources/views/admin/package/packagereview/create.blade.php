    ...
    @include('admin.package.include.topnavbar')
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="ibox">
                  <div class="ibox-head">
                      <div class="ibox-title">Add Package Review</div>
                  ...
                  <form method="post" action="{{route('packagereview.store', [$d_id])}}" enctype="multipart/form-data">
                    @csrf
                  <div class="ibox-body" style="">
                    ...
                    @endif
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" rows="3" cols="80">{{old('description')}}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="overall_review" value="{{old('overall_review')}}" type="number" min="1" max="5" placeholder="Only 1-5">
                    </div>
                    {{-- <div class="form-group">
                        <label>Pre trip info</label>
                        <input class="form-control" name="pre_trip_info" value="{{old('pre_trip_info')}}" type="number" min="1" max="5" placeholder="Only 1-5">
                    </div>
                    <div class="form-group">
                        <label>Meals</label>
                        <input class="form-control" name="meal" value="{{old('meal')}}" type="number" min="1" max="5" placeholder="Only 1-5">
                    </div>
                    <div class="form-group">
                        <label>Guides</label>
                        <input class="form-control" name="guide" value="{{old('guide')}}" type="number" min="1" max="5" placeholder="Only 1-5">
                    </div>
                    <div class="form-group">
                        <label>Transportation</label>
                        <input class="form-control" name="transportation" value="{{old('transportation')}}" type="number" min="1" max="5" placeholder="Only 1-5">
                    </div>
                    <div class="form-group">
                        <label>Value for Money</label>
                        <input class="form-control" name="value_for_money" value="{{old('value_for_money')}}" type="number" min="1" max="5" placeholder="Only 1-5">
                    </div>
                    <div class="form-group">
                        <label>Accommodation</label>
                        <input class="form-control" name="accommodation" value="{{old('accommodation')}}" type="number" min="1" max="5" placeholder="Only 1-5">
                    </div> --}}
