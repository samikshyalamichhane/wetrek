    ...
    @include('admin.package.include.topnavbar')
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="ibox">
                  <div class="ibox-head">
                      <div class="ibox-title">Add Package FAQ</div>
                  ...
                  <form method="post" action="{{route('packagefaq.store', [$d_id])}}" enctype="multipart/form-data">
                    @csrf
                          ...
                          <tbody>
                            ...
                            @if($details->count())
                              ...
                              <tr>
                                ...
                                <td>{!! \Illuminate\Support\Str::limit($data->answers, 200, '...') !!}</td>
