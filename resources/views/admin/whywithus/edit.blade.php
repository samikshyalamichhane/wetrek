                                            ...
                                            <div class="row">
                                                {{-- <div class="col-6 colxs-12">
                                                    ...
                                                    <div class="form-check checkbox">
                                                        ...
                                                        <img id="whywithus_iconframe" src="{{asset('images/thumbnail/'. $detail->whywithus_icon)}}" width="100px"
                                                            height="100px" />
                                                    </div>
                                                </div> --}}
                                                ...
                                                <div class="col-6 colxs-12">
                                                    ...
                                                    <div class="form-check checkbox">
                                                        ...
                                                        <img id="image1frame" src="{{asset('images/thumbnail/'. $detail->image1)}}" width="100px"
                                                            height="100px" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6 colxs-12">
                                                    ...
                                                    <div class="form-check checkbox">
                                                        ...
                                                        <img id="image2frame" src="{{asset('images/thumbnail/'. $detail->image2)}}" width="100px"
                                                            height="100px" />
                                                    </div>
                                                </div>
