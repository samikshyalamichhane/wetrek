...
<div class="page-heading">
    <h1 class="page-title">Travel With US</h1>
    <!-- <ol class="breadcrumb">
...
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">All Travel With US</div>
            <div>
                <a class="btn btn-info btn-md" href="{{route('whywithus.create')}}">Add Travel With US</a>
            </div>
        </div>
                  ...
                  @if($details->count())
                    ...
                    <tr>
                      ...
                      <td>{{$data->published == 1 ? 'Published' : 'Not Published'}}</td>
                        ...
                        <td>
                            <a href="{{route('whywithus.edit', $data->id)}}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>

                              <form class="adjust-delete-button" action="{{route('whywithus.destroy', $data->id)}}" method="post">
                                  @csrf
                                  @method('delete')
                                ...
                                <!-- <a href="{{route('whywithus.destroy', $data->id)}}" class="btn btn-danger btn-sm" style="border-radius:50%" onclick="return confirm('Are you sure you want to delete this Blog?')"><i class="fa fa-trash"></i></a> -->
                        </td>
                    </tr>
                    @endforeach
                    @else
