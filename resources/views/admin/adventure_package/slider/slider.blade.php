...
<div class="page-content fade-in-up">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">Add Adventure Package Multiple Images</div>
                ...
                <form method="post" action="{{route('adventurepackagemultipleimages.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="ibox-body" style="">
                        ...
                        @endif
                        <input type="hidden" name="adventurepackage_id" value="{{ $adventurepackage_id }}">
                ...
                <div class="ibox-body">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{++$key}}</td>
                                <td> <img src="{{ asset('images/adventure/package/multiple/'. $detail->sliderimages) }}" width="100">
                                </td>
                                <td>
                                    <form method="post" action="{{ route('adventurepackagemultipleimages.destroy', $detail->id) }}">
                                        @csrf
