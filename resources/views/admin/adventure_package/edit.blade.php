...
<div class="page-content fade-in-up">
    ...
    <form method="post" action="{{route('adventurepackage.update', $detail->id)}}" enctype="multipart/form-data">
        {{csrf_field()}}
        @method('put')
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Adventure Package Edit</div>
                    ...
                    <div class="ibox-body" style="">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label>Select Adventure</label>
                                <select name="adventure_id" class="form-control">
                                    <option value="">-- select one --</option>
                                    @foreach($adventures as $adventure)
                                        <option value="{{$adventure->id}}"{{$adventure->id==$detail->adventure_id?'selected':''}}>{{$adventure->name}}</option>
                                    @endforeach
                                </select>
                            </div>
