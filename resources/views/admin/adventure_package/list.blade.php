...
<div class="page-heading">
    <h1 class="page-title">Adventure Package</h1>
    <!-- <ol class="breadcrumb">
...
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">All Adventure Package</div>
            <div>
                    ...
                    <tr>
                      ...
                      <td>{{$data->published == 1 ? 'Published' : 'Not Published'}}</td>
                        ...
                        <td>
                            ...
                            <a href="{{route('adventurepackage.edit', $data->id)}}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
                            {{-- @endif --}}
                            {{-- @if($packageModule['full_access']==1) --}}
                              <form class="adjust-delete-button" action="{{route('adventurepackage.destroy', $data->id)}}" method="post">
                                  @csrf
                                  @method('delete')
                              ...
                              {{-- @endif --}}
                              {{-- @if($packageModule['edit_access']==1 || $packageModule['full_access']==1) --}}
                            <a class="btn btn-info btn-sm mt-2" href="{{route('adventurepackagemultipleimages.create', $data->id)}}">Package
                                Images</a>
                            {{-- @endif --}}
                        </td>
                    </tr>
