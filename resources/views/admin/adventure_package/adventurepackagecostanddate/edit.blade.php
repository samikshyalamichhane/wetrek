    ...
    @include('admin.adventure_package.include.topnavbar')
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="ibox">
                  <div class="ibox-head">
                      <div class="ibox-title">Edit Adventure Cost And Date</div>
                  ...
                  <form method="post" action="{{route('adventurepackagecostanddate.update', [$d_id, $detail->id])}}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                  ...
                  <div class="ibox-body">
                      <table class="table table-bordered table-hover">
                          ...
                          <tbody>
                            ...
                            @if($adventurepackagecostanddate->count())
                              @foreach($adventurepackagecostanddate as $key => $data)
                              ...
                              <tr>
                                ...
                                <td>{{$data->published == 1 ? 'Published' : 'Not Published'}}</td>
                                  ...
                                  <td>
                                      <a href="{{route('adventurepackagecostanddate.edit', [$d_id, $data->id])}}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>

                                        <form class="adjust-delete-button" action="{{route('adventurepackagecostanddate.destroy', [$d_id, $data->id])}}" method="post">
                                            @csrf
                                            @method('delete')
...
@include('admin.layouts._partials.ckdynamic', ['name' => 'adventurepackagecostanddate'])
@endpush
