    ...
    @include('admin.adventure_package.include.topnavbar')
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="ibox">
                  <div class="ibox-head">
                      <div class="ibox-title">Edit Adventure Package Equipment</div>
                  ...
                  <form method="post" action="{{route('adventurepackageequipment.update', [$d_id, $detail->id])}}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                  ...
                  <div class="ibox-body">
                      <table class="table table-bordered table-hover">
                          ...
                          <tbody>
                            ...
                            @if($adventurepackageequipment->count())
                              @foreach($adventurepackageequipment as $key => $data)
