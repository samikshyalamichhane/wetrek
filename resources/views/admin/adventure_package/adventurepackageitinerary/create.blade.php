    ...
    @include('admin.adventure_package.include.topnavbar')
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="ibox">
                  <div class="ibox-head">
                      <div class="ibox-title">Add Adventure Package Itinerary</div>
                  ...
                  <form method="post" action="{{route('adventurepackageitinerary.store', [$d_id])}}" enctype="multipart/form-data">
                    @csrf
    ...
    $( ".row_drag" ).sortable({
        ...
        stop: function() {
           ...
           $.ajax({
              ...
              url:"{{route('adventurepackageitinerary.update.order')}}",
           });
        }
    });
</script>
