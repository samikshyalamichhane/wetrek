    ...
    @include('admin.nature_package.include.topnavbar')
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="ibox">
                  <div class="ibox-head">
                      <div class="ibox-title">Edit Nature & Wildlife Package Itinerary</div>
                  ...
                  <form method="post" action="{{route('naturepackageitinerary.update', [$d_id, $detail->id])}}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                  ...
                  <div class="ibox-body">
                      <table class="table table-bordered table-hover">
                          ...
                          <tbody>
                            ...
                            @if($naturepackageitinerary->count())
                              @foreach($naturepackageitinerary as $key => $data)
                              ...
                              <tr>
                                ...
                                <td>{!! str_limit($data->activity_details, 200) !!}</td>
                                  ...
                                  <td>
                                      <a href="{{route('naturepackageitinerary.edit', [$d_id, $data->id])}}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>

                                        <form class="adjust-delete-button" action="{{route('naturepackageitinerary.destroy', [$d_id, $data->id])}}" method="post">
                                            @csrf
                                            @method('delete')
