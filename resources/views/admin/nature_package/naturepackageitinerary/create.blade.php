    ...
    @include('admin.nature_package.include.topnavbar')
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="ibox">
                  <div class="ibox-head">
                      <div class="ibox-title">Add Nature & Wildlife Package Itinerary</div>
                  ...
                  <form method="post" action="{{route('naturepackageitinerary.store', [$d_id])}}" enctype="multipart/form-data">
                    @csrf
    ...
    $( ".row_drag" ).sortable({
        ...
        stop: function() {
           ...
           $.ajax({
              ...
              url:"{{route('naturepackageitinerary.update.order')}}",
           });
        }
    });
</script>
