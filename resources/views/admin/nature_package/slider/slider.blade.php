...
<div class="page-content fade-in-up">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">Add Nature & Wildlife Package Multiple Images</div>
                ...
                <form method="post" action="{{route('naturepackagemultipleimages.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="ibox-body" style="">
                        ...
                        @endif
                        <input type="hidden" name="naturepackage_id" value="{{ $naturepackage_id }}">
                ...
                <div class="ibox-body">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{++$key}}</td>
                                <td> <img src="{{ asset('images/nature/package/multiple/'. $detail->sliderimages) }}" width="100">
                                </td>
                                <td>
                                    <form method="post" action="{{ route('naturepackagemultipleimages.destroy', $detail->id) }}">
                                        @csrf
