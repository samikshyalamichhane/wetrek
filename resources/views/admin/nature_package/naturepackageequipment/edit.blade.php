    ...
    @include('admin.nature_package.include.topnavbar')
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="ibox">
                  <div class="ibox-head">
                      <div class="ibox-title">Edit Nature & Wildlife Package Equipment</div>
                  ...
                  <form method="post" action="{{route('naturepackageequipment.update', [$d_id, $detail->id])}}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                  ...
                  <div class="ibox-body">
                      <table class="table table-bordered table-hover">
                          ...
                          <tbody>
                            ...
                            @if($naturepackageequipment->count())
                              @foreach($naturepackageequipment as $key => $data)
