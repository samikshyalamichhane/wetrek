    ...
    @include('admin.nature_package.include.topnavbar')
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="ibox">
                  <div class="ibox-head">
                      <div class="ibox-title">Edit Nature & Wildlife Cost And Date</div>
                  ...
                  <form method="post" action="{{route('naturepackagecostanddate.update', [$d_id, $detail->id])}}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                  ...
                  <div class="ibox-body">
                      <table class="table table-bordered table-hover">
                          ...
                          <tbody>
                            ...
                            @if($naturepackagecostanddate->count())
                              @foreach($naturepackagecostanddate as $key => $data)
...
@include('admin.layouts._partials.ckdynamic', ['name' => 'naturepackagecostanddate'])
@endpush
