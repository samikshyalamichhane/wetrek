...
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">All Package Enquiries</div>
        </div>
        <div class="ibox-body">
                      ...
                      <!--<td>{{$data->message}}</td>-->
                        <td>
                            <a href=""  class="btn btn-success btn-sm view" data-id="{{$data->id}}"><i class="fa fa-eye"></i></a>
                              <form class="adjust-delete-button" action="{{route('removePackageEnquiry', $data->id)}}" method="post">
                                  @csrf
                                  @method('delete')
