...
<div class="page-content fade-in-up">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">Add Tour Package Multiple Images</div>
                ...
                <form method="post" action="{{route('tourpackagemultipleimages.store')}}" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="ibox-body">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{++$key}}</td>
                                <td> <img src="{{ asset('images/tour/package/multiple/'. $detail->sliderimages) }}" width="100">
                                </td>
                                <td>
                                    <form method="post" action="{{ route('tourpackagemultipleimages.destroy', $detail->id) }}">
                                        @csrf
