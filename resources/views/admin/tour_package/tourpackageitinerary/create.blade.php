    ...
    @include('admin.tour_package.include.topnavbar')
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="ibox">
                  <div class="ibox-head">
                      <div class="ibox-title">Add Tour Package Itinerary</div>
                  ...
                  <form method="post" action="{{route('tourpackageitinerary.store', [$d_id])}}" enctype="multipart/form-data">
                    @csrf
    ...
    $( ".row_drag" ).sortable({
        ...
        stop: function() {
           ...
           $.ajax({
              ...
              url:"{{route('tourpackageitinerary.update.order')}}",
           });
        }
    });
</script>
