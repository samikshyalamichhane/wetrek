    ...
    @include('admin.tour_package.include.topnavbar')
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="ibox">
                  <div class="ibox-head">
                      <div class="ibox-title">Edit Tour Package Faq</div>
                  ...
                  <form method="post" action="{{route('tourpackagefaq.update', [$d_id, $detail->id])}}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                  ...
                  <div class="ibox-body">
                      <table class="table table-bordered table-hover">
                          ...
                          <tbody>
                            ...
                            @if($tourpackagefaq->count())
                              @foreach($tourpackagefaq as $key => $data)
                              ...
                              <tr>
                                ...
                                <td>{{$data->published == 1 ? 'Published' : 'Not Published'}}</td>
                                  ...
                                  <td>
                                      <a href="{{route('tourpackagefaq.edit', [$d_id, $data->id])}}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>

                                        <form class="adjust-delete-button" action="{{route('tourpackagefaq.destroy', [$d_id, $data->id])}}" method="post">
                                            @csrf
                                            @method('delete')
