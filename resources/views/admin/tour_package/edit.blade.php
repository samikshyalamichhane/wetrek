...
<div class="page-content fade-in-up">
    ...
    <form method="post" action="{{route('tourpackage.update', $detail->id)}}" enctype="multipart/form-data">
        {{csrf_field()}}
        @method('put')
        <div class="row">
            <div class="col-md-12">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="tour_id" class="form-control">
                                    ...
                                    @foreach($tours as $tour)
                                        <option value="{{$tour->id}}"{{$tour->id==$detail->tour_id?'selected':''}}>{{$tour->name}}</option>
                                    @endforeach
                                </select>
                            </div>
