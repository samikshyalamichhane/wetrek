    ...
    @include('admin.tour_package.include.topnavbar')
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="ibox">
                  <div class="ibox-head">
                      <div class="ibox-title">Edit Tour Package Equipment</div>
                  ...
                  <form method="post" action="{{route('tourpackageequipment.update', [$d_id, $detail->id])}}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                  ...
                  <div class="ibox-body">
                      <table class="table table-bordered table-hover">
                          ...
                          <tbody>
                            ...
                            @if($tourpackageequipment->count())
                              @foreach($tourpackageequipment as $key => $data)
