    ...
    <div class="col-md-12">
      <div class="ibox">
        ...
        <div class="ibox-head">
          ...
          <div>
              <a class="btn btn-info btn-md" href="{{route('package.create')}}">Add Destination</a>
          </div>
        </div>
        ...
        <div class="clf">
            <ul class="nav nav-tabs tabs-line nav-fill">
                {{-- <li class="nav-item">
                    <a class="nav-link {{\Request::is('admin/package/'.$d_id.'/edit') ? 'active' : ''}}" href="{{route('package.edit', [$d_id])}}"><i class="ti-menu"></i> Destination Details</a>
                </li> --}}
                {{-- <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link {{\Request::is('admin/destination/'.$d_id.'/edit') ? 'active' : ''}}" href="{{route('destinationfaq.create', [$d_id])}}"><i class="fa fa-calendar"></i> Destination FAQ</a>
