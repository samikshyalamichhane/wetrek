    ...
    @include('admin.helitour_package.include.topnavbar')
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="ibox">
                  <div class="ibox-head">
                      <div class="ibox-title">Edit Heli Tour Package Faq</div>
                  ...
                  <form method="post" action="{{route('helitourpackagefaq.update', [$d_id, $detail->id])}}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                  ...
                  <div class="ibox-body">
                      <table class="table table-bordered table-hover">
                          ...
                          <tbody>
                            ...
                            @if($helitourpackagefaq->count())
                              @foreach($helitourpackagefaq as $key => $data)
