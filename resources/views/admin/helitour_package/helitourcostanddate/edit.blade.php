    ...
    @include('admin.helitour_package.include.topnavbar')
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="ibox">
                  <div class="ibox-head">
                      <div class="ibox-title">Edit Heli Tour Cost And Date</div>
                  ...
                  <form method="post" action="{{route('helitourcostanddate.update', [$d_id, $detail->id])}}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                  ...
                  <div class="ibox-body">
                      <table class="table table-bordered table-hover">
                          ...
                          <tbody>
                            ...
                            @if($helitourcostanddate->count())
                              @foreach($helitourcostanddate as $key => $data)
                              ...
                              <tr>
                                ...
                                <td>{{$data->published == 1 ? 'Published' : 'Not Published'}}</td>
                                  ...
                                  <td>
                                      <a href="{{route('helitourcostanddate.edit', [$d_id, $data->id])}}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>

                                        <form class="adjust-delete-button" action="{{route('helitourcostanddate.destroy', [$d_id, $data->id])}}" method="post">
                                            @csrf
                                            @method('delete')
...
@include('admin.layouts._partials.ckdynamic', ['name' => 'helitourcostanddate'])
@endpush
