...
<div class="page-content fade-in-up">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">Add Heli Tour Package Multiple Images</div>
                ...
                <form method="post" action="{{route('helitourpackagemultipleimages.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="ibox-body" style="">
                        ...
                        @endif
                        <input type="hidden" name="helitourpackage_id" value="{{ $helitourpackage_id }}">
                ...
                <div class="ibox-body">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{++$key}}</td>
                                <td> <img src="{{ asset('images/helitour/package/multiple/'. $detail->sliderimages) }}" width="100">
                                </td>
                                <td>
                                    <form method="post" action="{{ route('helitourpackagemultipleimages.destroy', $detail->id) }}">
                                        @csrf
