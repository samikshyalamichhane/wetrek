<div class="row">
    <div class="col-md-12">
      <div class="ibox">
        ...
        <div class="ibox-head">
          <div class="ibox-title">Heli Tours Package</div>
          <div>
              <a class="btn btn-info btn-md" href="{{route('helitourpackage.create')}}">Add Heli Tour Package</a>
          </div>
        </div>
        ...
        <div class="clf">
            <ul class="nav nav-tabs tabs-line nav-fill">
                <li class="nav-item">
                    <a class="nav-link {{\Request::is('admin/helitourpackage/'.$d_id.'/edit') ? 'active' : ''}}" href="{{route('helitourpackage.edit', [$d_id])}}"><i class="ti-menu"></i> HeliTour Package Details</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{\Request::is('admin/package/*/helitourpackageitinerary/*') ? 'active' : ''}}" href="{{route('helitourpackageitinerary.create', [$d_id])}}"><i class="fa fa-calendar"></i> Itinerary</a>

                </li>
                <li class="nav-item">
                    <a class="nav-link {{\Request::is('admin/package/*/helitourpackageequipment/*') ? 'active' : ''}}" href="{{route('helitourpackageequipment.create', [$d_id])}}"><i class="fa fa-calendar"></i> Equipment</a>
                   
                </li>
                <li class="nav-item">
                    <a class="nav-link {{\Request::is('admin/package/*/helitourcostanddate/*') ? 'active' : ''}}" href="{{route('helitourcostanddate.create', [$d_id])}}"><i class="fa fa-calendar"></i> Cost and Date</a>
                   
                </li>
                <li class="nav-item">
                    <a class="nav-link {{\Request::is('admin/package/*/helitourpackagegdp/*') ? 'active' : ''}}" href="{{route('helitourpackagegdp.create', [$d_id])}}"><i class="fa fa-calendar"></i> Group Discount Prices</a>
                   
                </li>
                <li class="nav-item">
                    <a class="nav-link {{\Request::is('admin/package/*/helitourpackagefaq/*') ? 'active' : ''}}" href="{{route('helitourpackagefaq.create', [$d_id])}}"><i class="fa fa-calendar"></i> Package FAQ</a>
