    ...
    @include('admin.helitour_package.include.topnavbar')
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="ibox">
                  <div class="ibox-head">
                      <div class="ibox-title">Add Heli Tour Package Itinerary</div>
                  ...
                  <form method="post" action="{{route('helitourpackageitinerary.store', [$d_id])}}" enctype="multipart/form-data">
                    @csrf
    ...
    $( ".row_drag" ).sortable({
        ...
        stop: function() {
           ...
           $.ajax({
              ...
              url:"{{route('helitourpackageitinerary.update.order')}}",
           });
        }
    });
</script>
