    ...
    @include('admin.helitour_package.include.topnavbar')
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="ibox">
                  <div class="ibox-head">
                      <div class="ibox-title">Edit Heli Tour Package GDP</div>
                  ...
                  <form method="post" action="{{route('helitourpackagegdp.update', [$d_id, $detail->id])}}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                  ...
                  <div class="ibox-body">
                      <table class="table table-bordered table-hover">
                          ...
                          <tbody>
                            ...
                            @if($helitourpackagegdp->count())
                              @foreach($helitourpackagegdp as $key => $data)
