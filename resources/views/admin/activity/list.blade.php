...
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">All Activity</div>
            <div>
                <a class="btn btn-info btn-md" href="{{route('activity.create')}}">Add Activity</a>
            </div>
        </div>
                  ...
                  @if($details->count())
                    ...
                    <tr>
                      ...
                      <td>{{$data->published == 1 ? 'Published' : 'Not Published'}}</td>
                        ...
                        <td>
                            <a href="{{route('activity.edit', $data->id)}}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>

                              <form class="adjust-delete-button" action="{{route('activity.destroy', $data->id)}}" method="post">
                                  @csrf
                                  @method('delete')
