...
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            ...
            <div>
                <a class="btn btn-info btn-md" href="{{route('region.create')}}">Add Region</a>
            </div>
        </div>
                  ...
                  @if($details->count())
                    ...
                    <tr>
                      ...
                      <td>{{$data->publish == 1 ? 'Published' : 'Not Published'}}</td>
                        ...
                        <td>
                            <a href="{{route('region.edit', $data->id)}}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>

                              <form class="adjust-delete-button" action="{{route('region.destroy', $data->id)}}" method="post">
                                  @csrf
                                  @method('delete')
